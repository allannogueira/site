...
var slides   = [1]; //coloca os slides ordenados
var slidesID = [1];//id que esta no html banner.php
...
function Rotacionar() {
 /* if(pauseSlide == 0){
    ...
    $(".slide").hide();//efeito fadeOut

    //faz a transição
    $("#slide"+slidesID[slideAtivo]).fadeIn(1500);  //mostra slide
...
$(document).ready(function() {
  ...
  $("#bt1").click(function(){
    slideAtivo = slides.indexOf(5);
    pauseSlide = 0;
    Rotacionar();
  });

  $("#bt2").click(function(){
    slideAtivo = slides.indexOf(7);
    pauseSlide = 0;
    Rotacionar();
  });
});
