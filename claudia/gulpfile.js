...
gulp.task('scripts', function() {
    ...
    return gulp.src([,'node_modules/jquery/dist/jquery.min.js','app/scripts/src/_includes/**/*.js', 'app/scripts/src/**/*.js', 'node_modules/bootstrap/dist/js/bootstrap.min.js','node_modules/wowjs/dist/wow.min.js','node_modules/angular/angular.min.js'])
                //prevent pipe breaking caused by errors from gulp plugins
                .pipe(plumber())
...
gulp.task('styles', function() {
    ...
    return gulp.src(['app/styles/scss/init.scss','node_modules/bootstrap/dist/css/bootstrap.min.css','node_modules/hover.css/css/hover-min.css','node_modules/font-awesome/css/font-awesome.min.css','node_modules/wowjs/css/libs/animate.css'])
                //prevent pipe breaking caused by errors from gulp plugins
                .pipe(plumber({
...
gulp.task('html-deploy', function() {
    ...
    gulp.src('app/classes/*')
        //prevent pipe breaking caused by errors from gulp plugins
        //.pipe(plumber())
        .pipe(gulp.dest(diretorioDist+'/classes'));
    
    gulp.src('app/controller/*')
        //prevent pipe breaking caused by errors from gulp plugins
        //.pipe(plumber())
        .pipe(gulp.dest(diretorioDist+'/controller'));
